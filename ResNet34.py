...
# - ResNet 34 -----------------------------------------------------------------------------
class ResNet34Classifier(tf.keras.Model):
  # Constructor
  def __init__(self, output_size, lr):
    super(ResNet34Classifier, self).__init__()   # call the constructor of the super class
    ...
    # activation = None means linear Activation (because we apply relu after Batchnormalization)
    ...
    # here a ResNet34 Architecture is build [3, 4, 6, 3]
